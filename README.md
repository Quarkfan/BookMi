...
| **Phase 6: 导入导出与备份** | CSV导入导出、封面ZIP、备份包、iCloud、恢复 | ✅ |
| **Phase 7: 数据维护与安全** | CSV/备份/导入导出UI、借出管理、AI设置(含真实API测试)、数据质量 | ✅ |
| **Phase 8: 打磨** | 统计完善、TODO清理、入口打通、渠道删除 | ✅ |
...
| 2026-05-28 | `2908956` | Phase 3 完成：图书列表筛选/排序、图书详情页（含封面/标签/书柜/阅读状态实时切换） |
| 2026-05-28 | `23cc251` | Phase 4 完成：书柜CRUD、标签管理（颜色）、批量操作（多选删除/移动/标签/状态）、设置页面、渠道管理 |
| 2026-05-28 | `60f7aa4` | Phase 5 完成：统计分析页面（总量/年度/书柜/阅读状态/作者/出版社/渠道/标签/数据质量/重复图书） |
| 2026-05-28 | `e5720ce` | 全面测试覆盖：Pinyin/Settings/BookRepo/ShelfRepo/TagRepo/SearchRepo/BookFactory 单元测试 |
| 2026-05-28 | `b28a214` | Phase 6 完成：CSV导入导出、完整备份包（SQLite+JSON+Covers+Manifest）、备份恢复（覆盖/合并/仅图书）、集成测试 |
| 2026-05-28 | `5c3a4aa` | Phase 7 完成：CSV导入/导出UI、备份/恢复UI、借出管理（借出/归还/历史）、AI设置（含真实OpenAI兼容API测试）、数据质量计算 |
| 2026-05-28 | `62aad70` | Phase 8 完成：统计完善（作者/出版社/渠道/标签/数据质量）、TODO清理、入口打通、渠道删除 |
